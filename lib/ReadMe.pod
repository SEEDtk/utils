...
relevant to the external environments for which the so-called Unix mode was
designed.
...
All the data in the database is stored in a TAR file at ftp://ftp.kbase.us/SEEDtk/reprepo.tar.gz.

Download this file into your data directory. From a command-line prompt within that directory,
do
